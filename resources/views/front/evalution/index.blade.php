...
@section('content')
<br><br>
<link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=https%3A%2F%2Fform.jotform.com%2F251012049024441" title="oEmbed Form">
<link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=https%3A%2F%2Fform.jotform.com%2F251012049024441" title="oEmbed Form">
<meta property="og:title" content="Event Feedback Form" >
<meta property="og:url" content="https://form.jotform.com/251012049024441" >
...
<script>
      ...
      </script><link rel="canonical" href="https://form.jotform.com/251012049024441" />
<!-- <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=2.0, user-scalable=1" /> -->
<!-- <meta name="HandheldFriendly" content="true" /> -->
<!-- <title>Event Feedback Form</title> -->
<link type="text/css" rel="stylesheet" href="https://cdn01.jotfor.ms/stylebuilder/static/form-common.css?v=c79fd50
"/>
<style type="text/css">@media print{*{-webkit-print-color-adjust: exact !important;color-adjust: exact !important;}.form-section{display:inline!important}.form-pagebreak{display:none!important}.form-section-closed{height:auto!important}.page-section{position:initial!important}}</style>
<link type="text/css" rel="stylesheet" href="https://cdn02.jotfor.ms/themes/CSS/5e6b428acc8c4e222d1beb91.css?v=3.3.62236&themeRevisionID=5eb3b4ae85bd2e1e2966db96"/>
<link type="text/css" rel="stylesheet" href="https://cdn03.jotfor.ms/css/styles/payment/payment_styles.css?3.3.62236" />
<link type="text/css" rel="stylesheet" href="https://cdn01.jotfor.ms/css/styles/payment/payment_feature.css?3.3.62236" />
...
<script type="text/javascript"> 
  ...
  window.addEventListener('DOMContentLoaded',function(){window.brandingFooter.init({"formID":251012049024441,"campaign":"powered_by_jotform_le","isCardForm":false,"isLegacyForm":true,"formLanguage":"en"})});
...
if (window.JotForm && JotForm.accessible) $('input_38').setAttribute('tabindex',0);
  /*INIT-END*/
   ...
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,{"name":"clickTo","qid":"1","text":"Event Feedback","type":"control_head"},{"name":"submitForm","qid":"2","text":"Submit Form","type":"control_button"},{"name":"clickTo3","qid":"3","text":"Optional: Contact Details","type":"control_head"},{"name":"yourName","qid":"4","text":"Your Name","type":"control_fullname"},{"name":"email5","qid":"5","text":"E-mail","type":"control_email"},{"name":"phoneNumber6","qid":"6","text":"Phone Number","type":"control_phone"},null,null,{"name":"whichEvent9","qid":"9","text":"Which  event did you attend?","type":"control_dropdown"},null,{"name":"clickTo11","qid":"11","text":"The Presenters","type":"control_head"},{"name":"clickTo12","qid":"12","text":"The Venue","type":"control_head"},null,null,null,null,{"name":"howWas17","qid":"17","text":"How was the quality of the food?","type":"control_scale"},null,{"name":"inYour","qid":"19","text":"In your opinion, what is the most important feature we should look for when choosing a venue?","type":"control_textarea"},null,null,null,{"name":"overallHow23","qid":"23","text":"Overall, how entertaining was the event?","type":"control_scale"},{"name":"doYou","qid":"24","text":"Do you feel the day provided value for money?","type":"control_scale"},{"name":"afterThe25","qid":"25","text":"After the event, how inspired did you feel?","type":"control_scale"},{"name":"wouldYou","qid":"26","text":"Would you recommend a similar event to a friend?","type":"control_radio"},{"name":"clickTo27","qid":"27","text":"Final Thoughts?","type":"control_head"},{"name":"ifYou","qid":"28","text":"If you were running the event, what would you have done differently?","type":"control_textarea"},null,{"name":"whatWas","qid":"30","text":"What was the single best part of the event?","type":"control_radio"},{"name":"presenter1","qid":"31","text":"Presenter 1","type":"control_matrix"},{"name":"presenter4","qid":"32","text":"Presenter 4","type":"control_matrix"},{"name":"presenter3","qid":"33","text":"Presenter 3","type":"control_matrix"},{"name":"presenter2","qid":"34","text":"Presenter 2","type":"control_matrix"},null,{"name":"overallWere36","qid":"36","text":"Overall, were you satisfied with the venue and were you able to see and hear the presentations clearly?","type":"control_radio"},{"name":"whatProblems","qid":"37","text":"What problems did you encounter?","type":"control_textarea"},{"name":"anyFinal38","qid":"38","text":"Any final comments?","type":"control_textarea"},null,null,null,null,null,null,{"name":"anySuggestions45","qid":"45","text":"Any suggestions for future event topics?","type":"control_textarea"},null,null,null,null,{"name":"wasThere","qid":"50","text":"Was there a large enough selection of food?","type":"control_radio"}]);}, 20); 
</script>
</head>
<!-- <body> -->
...
<!--   <input type="hidden" id="JWTContainer" value="" />
  ...
  <input type="hidden" id="jsExecutionTracker" name="jsExecutionTracker" value="build-date-1744450791059" />
  <input type="hidden" id="submitSource" name="submitSource" value="unknown" />
  <input type="hidden" id="buildDate" name="buildDate" value="1744450791059" />
    ...
    <ul class="form-section page-section" role="presentation">
     ...
     <!--  <li class="form-line" data-type="control_textarea" id="id_19"><label class="form-label form-label-top form-label-auto" id="label_19" for="input_19" aria-hidden="false"> In your opinion, what is the most important feature we should look for when choosing a venue? </label>
      ...
      <li id="cid_27" class="form-input-wide" data-type="control_head">
        <div class="form-header-group  header-default">
          <div class="header-text httal htvam">
            <h2 id="header_27" class="form-header" data-component="header">Final Thoughts?</h2>
          </div>
        </div>
      </li>
      ...
      <li class="form-line" data-type="control_button" id="id_2">
        <div id="cid_2" class="form-input-wide" data-layout="full">
          <div data-align="auto" class="form-buttons-wrapper form-buttons-auto   jsTest-button-wrapperField">
            <button id="input_2" type="submit" class="form-submit-button form-submit-button-navy-700 submit-button jf-form-buttons jsTest-submitField legacy-submit" data-component="button" data-content="">Submit Form</button>

            <a href="{{route('resource')}}" class="btn btn-primary" style="margin-left: 12px;">Back</a>
          </div>
        </div>
      </li>
