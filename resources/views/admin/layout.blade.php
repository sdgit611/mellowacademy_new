                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ route('requested_developer_details') }}"
                                            ...
                                            <i class="material-icons">verified_user</i> Developer Request
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="{{ route('resoure_details') }}"
                                            ...
                                            <i class="material-icons">integration_instructions</i> Resource
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="{{ route('premium') }}"
                                            class="{{ request()->routeIs('premium') ? 'active' : '' }}">
                                            <i class="fas fa-coins"></i> Try to Premium
                                        </a>
                                    </li>
